...
{
    public enum NumberParseErrorType
    {
    ...
    public class NumberParseException : Exception
    {
        ...
        private NumberParseErrorType errorType;
        private String message;

        public NumberParseException(NumberParseErrorType errorType, String message)
            : base(message)
        {
   ...
   */
        ...
        public NumberParseErrorType getErrorType()
        {
            return errorType;
        }
