...
public class ShortNumberInfo {
  private static readonly Logger logger = Logger.getLogger(typeof(ShortNumberInfo));
  ...
  private static readonly ISet<String> REGIONS_WHERE_EMERGENCY_NUMBERS_MUST_BE_EXACT =
      new HashSet<String>();
  ...
  internal ISet<String> getSupportedRegions() {
    return MetadataManager.getShortNumberMetadataSupportedRegions();
  }
